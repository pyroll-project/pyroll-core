...
__all__ = ["GenericAngleGroove"]


class GenericAngleGroove(GrooveBase, ReprMixin):
    """Represents a groove defined by the generic angle groove geometry."""
    ...
    def __init__(
            ...
            inner_usable_width: Optional[float] = None,
        ...
        self._inner_usable_width = inner_usable_width
